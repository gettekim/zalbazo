        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            <main id="main" class="col-md-9 float-left col pl-md-5 pt-3 main">
                        ...
                        <c:forEach items="${AnimalList}" var="animal">
                            <tr>
                                ...
                                <td class="mobile" style="text-align:center;">
                                    <c:out value="없음" />
                                <%-- <td><a style="color: #000000;" href='/jisikdong/get?id=<c:out value="${animal.id}"/>'> --%>
                                        <td><c:out value="${animal.name}" /></td>

                                </td>
                                <td class="mobile" style="text-align:center;">
                                     		<button onclick="location.href='modify?id=${animal.id}'">수정</button>
                                     		<button onclick="location.href='remove?id=${animal.id}'">삭제</button>
                                </td>
                ...
                <div style="max-width: 1080px;">
                    <a href="/mypage/register" id='regBtn' type="button" class="btn btn-primary float-right">글쓰기</a>
                </div>
